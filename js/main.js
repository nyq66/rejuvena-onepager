...
(function ($) {
    ...
    /* ===================================
     Scroll Animation - Slide In Effects
     ====================================== */
    ...
    if ('IntersectionObserver' in window) {
        ...
        $('section').not('.hero-section').each(function(index) {
            var animationClass = 'section-animate';
        ...
        // Stagger gallery cards for a flowing slide-up reveal.
        var galleryItems = document.querySelectorAll('#pricing .row.row-cols-1.row-cols-md-2.row-cols-lg-4.g-4 > .col');
        galleryItems.forEach(function(item) {
            item.classList.add('gallery-flow-item');
        });
        ...
        if (galleryItems.length) {
            var galleryObserver = new IntersectionObserver(function(entries) {
                entries.forEach(function(entry) {
                    if (entry.isIntersecting) {
                        var cards = entry.target.querySelectorAll('.gallery-flow-item');
            ...
            var gallerySection = document.getElementById('pricing');
            if (gallerySection) {
